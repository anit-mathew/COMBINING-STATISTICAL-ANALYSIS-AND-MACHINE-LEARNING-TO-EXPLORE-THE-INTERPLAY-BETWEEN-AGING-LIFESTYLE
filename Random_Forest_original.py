...
print("Random Forest of Original data")
print(report)

# Perform k-fold cross-validation using StratifiedKFold
kfold = StratifiedKFold(n_splits=5, shuffle=True, random_state=42)
cv_results = cross_val_score(rf_model, X_encoded, y, cv=kfold, scoring='accuracy')
...
plt.title('Random Forest Classifier - Variable Importance for Original data')
