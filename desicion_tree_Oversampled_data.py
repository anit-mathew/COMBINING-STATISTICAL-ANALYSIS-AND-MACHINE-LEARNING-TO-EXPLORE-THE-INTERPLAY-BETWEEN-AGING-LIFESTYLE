...
# Plot feature importance in descending order (horizontal bar plot)
plt.barh(sorted_features, sorted_importance, color='skyblue')
plt.xlabel('Importance')
plt.ylabel('Feature')
plt.title('Decision Tree Classifier - Feature Importance for oversampled data')
plt.show()

print("Result of oversampled data\n")
