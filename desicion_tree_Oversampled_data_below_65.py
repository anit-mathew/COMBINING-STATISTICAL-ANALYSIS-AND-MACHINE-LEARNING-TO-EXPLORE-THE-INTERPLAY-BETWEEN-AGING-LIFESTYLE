...
plt.barh(sorted_features, sorted_importance)  # Use barh instead of bar
plt.xlabel('Importance')
plt.ylabel('Feature')
plt.title('Decision Tree Classifier - Feature Importance for below 65')
plt.show()

print("Result of oversampled data below 65\n")
